...
b2FixtureDef Parser::parseFixtureDef(const pugi::xml_node& fixtureNode)
{
...
b2CircleShape Parser::parseCircle(const pugi::xml_node& circleNode)
{
...
b2EdgeShape Parser::parseEdge(const pugi::xml_node& edgeNode)
{
    b2EdgeShape edge;
...
b2PolygonShape Parser::parsePolygon(const pugi::xml_node& polygonNode)
{
...
b2ChainShape Parser::parseChain(const pugi::xml_node& chainNode)
{
    b2ChainShape chain;
...
std::vector<b2Vec2> Parser::parseVertices(const pugi::xml_node& verticesNode)
{
