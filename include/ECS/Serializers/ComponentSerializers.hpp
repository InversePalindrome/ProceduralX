...
namespace ECS::Serializers
{
    ...
    void serializePosition(const Components::PositionComponent& position, pugi::xml_node& positionNode);
    void serializeRotation(const Components::RotationComponent& rotation, pugi::xml_node& rotationNode);
